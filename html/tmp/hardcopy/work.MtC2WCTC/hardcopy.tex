...
\smallskip
%% decoded old answers, saved. (keys = 
{\bf 1. {\footnotesize (1 pt) setaliasCheck\-/htmlAliasCheck\-/htmlAliasCheck.pg}}\newline {\bf  Check that the alias command works to find HTML files } \par 
All of these tests should succeed.
\par 

This should find a static .gif graph file in the same directory.\par 
\includegraphics[width=0.8\linewidth]{/Volumes/WW_test/opt/webwork/courses/gage_test/html/tmp/images/14d95a9e-f484-3f4b-9c07-55615f08780f___598e45c6-236f-3b36-bae7-322023038e7e.png}
\par 
\-/Volumes\-/WW\_test\-/opt\-/webwork\-/courses\-/gage\_test\-/html\-/tmp\-/images\-/14d95a9e-f484-3f4b-9c07-55615f08780f\_\_\_598e45c6-236f-3b36-bae7-322023038e7e.png \par 

This should find a static .png graph file in the same directory.\par 
\includegraphics[width=0.8\linewidth]{/Volumes/WW_test/opt/webwork/courses/gage_test/templates/setaliasCheck/htmlAliasCheck/3.png}
\par 
\-/Volumes\-/WW\_test\-/opt\-/webwork\-/courses\-/gage\_test\-/templates\-/setaliasCheck\-/htmlAliasCheck\-/3.png \par 


This should find an html file in the same directory.
{\bf \underline{url }} should bring up a new html page.
\par 
\-/webwork2\_course\_files\-/gage\_test\-/tmp\-/html\-/14d95a9e-f484-3f4b-9c07-55615f08780f\_\_\_d65dd60c-5b82-3804-a664-317f0d8784ae.html
\par 

  prettyprint resources: \leavevmode\\\relax 3 prob14hint prob14%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WeBWorK Online Homework Delivery System
% Copyright © 2000-2007 The WeBWorK Project, http://openwebwork.sf.net/
% $CVSHeader: webwork2/conf/snippets/hardcopyProblemDivider.tex,v 1.3 2004/06/24 21:10:50 dpvc Exp $
% 
...
\smallskip
%% decoded old answers, saved. (keys = 
{\bf 2. {\footnotesize (1 pt) Library\-/Rochester\-/setSampleGraphs\-/prob8.pg}}\newline \includegraphics[width=0.8\linewidth]{/Volumes/WW_test/opt/webwork/courses/gage_test/html/tmp/images/9dfb9866-a2c7-3206-90b2-e5ea1d86929a___82b47a6e-0d5c-3393-95eb-04176cdd3d39.png}
...
\par 
You can view the {\bf \underline{source}} for this problem.
or consult the {\bf \underline{documentation}}  for  more details on the PG language.
